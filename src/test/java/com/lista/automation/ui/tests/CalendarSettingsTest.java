...
public class CalendarSettingsTest extends BaseTest {
    ...
    public void testCalendarView(String selector, CalendarView views) throws Exception {
    ...
    public void testCalendarSettings(String dayOfWeek, ViewStartOn viewStartOn, String cellDuration) throws Exception {
